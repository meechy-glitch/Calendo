  ...
  return (
    <>
      <div
        ...
        style={{ backgroundColor: "#1A1A1A", borderColor: "#E1306C" }}
      >
        <div className="mb-3 flex items-center gap-2">
          <Bell size={15} style={{ color: "#E1306C" }} />
          ...
          {posts.map((post) => (
            ...
            >
              ...
              <button
                ...
                className="ml-3 flex-shrink-0 rounded px-2.5 py-1 text-xs font-medium transition-colors hover:bg-[#E1306C] hover:text-white"
                style={{
